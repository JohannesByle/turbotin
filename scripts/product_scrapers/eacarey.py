...
def scrape(pbar=None):
    ...
    data = []
    name = "eacarey"
    url = "https://www.eacarey.com/other-branded-pipe-tobacco.html"
    ...
    for category in soup.find_all("div", class_="fcol"):
        if category.find_all(class_="price"):
            ...
            link = "https://www.eacarey.com/" + category.find("a").get("href")
            item, price, stock, link = add_item(data, name, item, price, stock, link, pbar)
        else:
            new_soup = get_html("https://www.eacarey.com/" + category.find("a").get("href"))
            for product in new_soup.find_all(class_="section-multi-item"):
                ...
                link = "https://www.eacarey.com/" + product.find("a").get("href")
                item, price, stock, link = add_item(data, name, item, price, stock, link, pbar)
